...
export const my: TranslationDict = {
  ...
  // ---------------------------------------------------------------------------
  brand: "DearUs",
  tagline: "မင်းအတွက်ရော... ငါတို့နှစ်ယောက်အတွက်ပါ 💕",
  taglineShort: "မင်းအတွက်၊ ငါတို့အတွက်",

  // ---------------------------------------------------------------------------
  // Landing Page — Hero
  // ---------------------------------------------------------------------------
  heroTitle: "ချစ်သူလေးအတွက် သီးသန့် Surprise လေး 💕",
  heroDescription:
    "မေးခွန်းလေးတွေ ဖန်တီးပြီး ချစ်သူလေးဆီ ပို့လိုက်ပါ 💌",
  createCta: "မင်းအတွက် သီးသန့် အမှတ်တရလေး လုပ်ကြရအောင်",
  ...
  howStep1Desc: "ခဏလေးနဲ့ အလွယ်တကူ ဖန်တီးမယ်",
  howStep2Title: "ဖြည့်မယ်",
  howStep2Desc: "စိတ်ကြိုက် မေးခွန်းလေးတွေနဲ့ အဖြေလေးတွေ ထည့်မယ်",
  howStep3Title: "ပို့မယ်",
  howStep3Desc: "Private Link သို့မဟုတ် QR Code နည်းနဲ့ ပို့ပေးပါ",
  ...
  // ---------------------------------------------------------------------------
  finalCtaTitle: "ချစ်သူလေးကို ပြုံးသွားစေချင်လား?",
  ...
  // Landing Page — Footer
  // ---------------------------------------------------------------------------
  footerMadeWith: "အချစ်တွေအပြည့်နဲ့ ဖန်တီးထားပါတယ်",
  ...
  previewCardIntro: "မင်းတစ်ယောက်တည်းအတွက် လုပ်ပေးထားတာ...\nအမှန်အတိုင်းပဲ ဖြေပေးနော် 🥹",
